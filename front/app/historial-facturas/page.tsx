...
export default function HistorialFacturasPage() {
  ...
  //confirmar decarga de la factura
  const [confirmarDescarga, setConfirmarDescarga] = useState<{
    visible: boolean;
    factura?: Factura;
  }>({ visible: false });
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 w-80 animate-fadeIn">
              ...
              <p className="text-gray-700 mb-6">
                ...
                <span className="font-mono font-semibold text-blue-600">
                  {confirmarDescarga.factura?.num_factura}
                </span>
                ?
              </p>
              ...
              <div className="flex justify-end gap-3">
                <button
                  onClick={() => setConfirmarDescarga({ visible: false })}
                ...
                <button
                  onClick={() => {
                    descargarPDF(confirmarDescarga.factura!.num_factura);
                    setConfirmarDescarga({ visible: false });
                  }}
                  ...
                  {facturasFiltradas.map((f, i) => (
                    <tr key={i} className="border-b hover:bg-gray-50">
                      ...
                      <td className="px-4 py-2 text-center">
                        <button
                          onClick={() => setConfirmarDescarga({ visible: true, factura: f })}
