...
import { Search, Plus, MoreVertical, Edit, Trash2, X } from "lucide-react"; // Añadimos X para cerrar
...
export default function EmpleadosPage() {
    ...
    return (
        <div className="p-10 max-w-7xl mx-auto relative">
            ...
            {/* BARRA DE BÚSQUEDA Y TABLA AQUÍ... (es el mismo código de antes) */}
                    ...
                    <tbody className="divide-y divide-gray-100">
                        {empleadosFiltrados.map((empleado) => (
                            <tr key={empleado.id} className="hover:bg-gray-50/50 transition-colors group">
                                <td className="px-6 py-4 font-medium text-quality-dark">{empleado.nombre}</td>
            ...
            {/* =========================================
          VENTANA MODAL (Formulario Nuevo Empleado) 
                ...
                <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center backdrop-blur-sm transition-opacity">
                    <div className="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden transform transition-all">
                        ...
                        <div className="px-6 py-4 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
                            <h3 className="text-lg font-bold text-quality-dark">Añadir Nuevo Empleado</h3>
                            <button
                        ...
                        <div className="px-6 py-4 border-t border-gray-100 flex justify-end gap-3 bg-gray-50/50">
                            ...
                            <button
                                onClick={() => {
                                    alert("Simulación: Empleado guardado (A la espera del Backend)");
